...
\]
\[
\frac{dy}{dt} = y_x =  x\frac{d\theta}{dt} = x\omega
\]
...
Torque in 3D is given as: $\tau = r \times F$. The tangential velocity is given as $v = \omega \times r$. These can be imagined using the right hand rule for cross products. For a more thorough physics derivation, consult an introductory physics book.