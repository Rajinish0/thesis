...
The sprite renderer class also comes with a \texttt{Sprite} class and all the 2D sprites must be loaded using this class -- this avoid reloading the sprites unnecessarily.

\lstset{caption={Frame Buffer example}, label=src:text_and_sprite}
\begin{lstlisting}[language={C++}]
