...
% Document's metadata
\title{Procedural Terrain and Volumetric Cloud Generation for Interactive Gameplay} % title
\date{2025} % year of defense

% Author's metadata
\author{Rajinish Aneel Bhatia}
\degree{Computer Science BSc}

% Superivsor(s)' metadata
\supervisor{Szabó Dávid} % internal supervisor's name
...
\department{Department of Media and Educational Technology} % department's name
\city{Budapest} % city
